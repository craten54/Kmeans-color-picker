...
st.markdown(f"""
    ...
    html, body, #root, [data-testid="stAppViewContainer"] {{
        ...
        overflow: hidden !important; /* Hindari scrollbar yang tidak diinginkan di body/html */
    ...
    .stSidebar {{
        ...
        overflow: hidden !important; /* Pastikan tidak ada scrollbar di sidebar */
    ...
    /* Target inner divs of sidebar to ensure full height and no padding/margin */
    .stSidebar > div:first-child {{ /* Target the outer most div within stSidebar (e.g., st-emotion-cache-xxxxxx) */
        padding: 0 !important;
        margin: 0 !important;
        ...
        align-items: stretch !important; /* Stretch children to fill */
        justify-content: center !important; /* Vertically center if content is smaller */
        overflow: hidden !important; /* Hide overflow from this div too */
    }}
    .stSidebar > div:first-child > div:first-child {{ /* Target the next inner div */
        padding: 0 !important;
        margin: 0 !important;
        background-color: transparent !important;
        height: 100% !important;
    ...
    .stSidebar .element-container {{ /* Target the specific div around st.image */
        width: 100% !important;
        height: 100% !important;
        margin: 0 !important;
        padding: 0 !important;
...
with st.sidebar:
    if gummy_image_loaded_successfully:
        ...
        st.markdown("""
            <style>
                /* Menargetkan div yang membungkus gambar st.image */
                .stSidebar .stImage {{
                    width: 100% !important;
                    height: 100% !important;
                    margin: 0 !important;
